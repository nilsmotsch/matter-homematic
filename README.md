...
- **One bridge, all ecosystems simultaneously** — the primary use case: Matter multi-admin lets Apple Home, Alexa and Google Home control the same devices side by side, with consistent live state everywhere. Apple Home + Alexa is verified in daily use.
...
1. Download the addon tarball: [**matter-homematic-0.11.0.tar.gz**](https://github.com/nilsmotsch/matter-homematic/releases/download/v0.11.0/matter-homematic-0.11.0.tar.gz) (always newest: [latest release](https://github.com/nilsmotsch/matter-homematic/releases/latest)) — or build it yourself with `npm run build:addon`.
